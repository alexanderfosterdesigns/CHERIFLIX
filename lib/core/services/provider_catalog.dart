...
class ProviderCatalog {
  ...
  static const List<ProviderDescriptor> _defaultProviders =
    ...
    ProviderDescriptor(
      ...
      key: 'vidking',
      label: 'VidKing',
      buildMovieUri: _vidKingMovie,
      buildShowUri: _vidKingShow,
      buildEpisodeUri: _vidKingEpisode,
    ),
    ProviderDescriptor(
      canonicalIndex: 18,
      key: 'vidapi',
      label: 'VidAPI',
      buildMovieUri: _vidApiMovie,
      buildShowUri: _vidApiShow,
      buildEpisodeUri: _vidApiEpisode,
    ),
    ProviderDescriptor(
      canonicalIndex: 19,
      key: 'vidnest',
      label: 'VidNest',
      buildMovieUri: _vidNestMovie,
      buildShowUri: _vidNestShow,
      buildEpisodeUri: _vidNestEpisode,
    ),
    ProviderDescriptor(
      canonicalIndex: 20,
      key: 'vidapi_xyz',
      label: 'VidAPI.xyz',
      buildMovieUri: _vidApiXyzMovie,
      buildShowUri: _vidApiXyzShow,
      buildEpisodeUri: _vidApiXyzEpisode,
    ),
    ProviderDescriptor(
      canonicalIndex: 21,
      key: 'vidsrc_xyz',
      label: 'VidSrc.xyz',
      buildMovieUri: _vidSrcXyzMovie,
      buildShowUri: _vidSrcXyzShow,
      buildEpisodeUri: _vidSrcXyzEpisode,
    ),
    ProviderDescriptor(
      canonicalIndex: 22,
      key: '111movies_com',
      label: '111Movies.com',
      buildMovieUri: _oneElevenMoviesComMovie,
      buildShowUri: _oneElevenMoviesComShow,
      buildEpisodeUri: _oneElevenMoviesComEpisode,
    ),
    ProviderDescriptor(
      canonicalIndex: 23,
      key: 'vixsrc',
      label: 'VixSrc',
      buildMovieUri: _vixSrcMovie,
      buildShowUri: _vixSrcShow,
      buildEpisodeUri: _vixSrcEpisode,
    ),
    ProviderDescriptor(
      canonicalIndex: 24,
      key: 'autoembed_cc',
      label: 'AutoEmbed.cc',
      buildMovieUri: _autoEmbedCcMovie,
      buildShowUri: _autoEmbedCcShow,
      buildEpisodeUri: _autoEmbedCcEpisode,
    ),
    ProviderDescriptor(
      canonicalIndex: 25,
      key: 'vidsrc_cc',
      label: 'VidSrc.cc',
      buildMovieUri: _vidSrcCcMovie,
      buildShowUri: _vidSrcCcShow,
      buildEpisodeUri: _vidSrcCcEpisode,
    ),
    ProviderDescriptor(
      canonicalIndex: 1,
      key: 'vidlink',
  ...
  static Uri? buildUri({
    ...
    if (seasonNumber != null && episodeNumber != null) {
      return provider.buildEpisodeUri(
          tmdbId, seasonNumber, episodeNumber, settings);
    }
  ...
  // API: /embed/movie/{tmdbId}  |  /embed/tv/{tmdbId}/{season}/{episode}
  // Only autoplay is enabled here. CHERIFLIX owns episode selection and
  // next-episode behavior after the hidden embed extracts a direct stream.
  // ---------------------------------------------------------------------------
  static Uri _vidKingMovie(int tmdbId, ProfilePlaybackSettings settings) =>
      Uri.https(
        'www.vidking.net',
        '/embed/movie/$tmdbId',
        const <String, String>{
  ...
  static Uri? _vidKingShow(int tmdbId, ProfilePlaybackSettings settings) =>
      Uri.https(
        'www.vidking.net',
        '/embed/tv/$tmdbId/1/1',
        const <String, String>{
  ...
  // VidAPI — https://vidapi.ru/api
  // Public embeds are served by vaplayer.ru. Controls and overlays are hidden
  // because CHERIFLIX owns the TV UI while the hidden embed extracts playback.
  static Map<String, String> _vidApiQuery(
    ProfilePlaybackSettings settings,
  ) =>
      <String, String>{
        'autoplay': '1',
        ...
        'overlay': 'false',
        'showTitle': 'false',
        'ds_lang': settings.preferredAudioLanguageCode,
      };

  static Uri _vidApiMovie(int tmdbId, ProfilePlaybackSettings settings) =>
      Uri.https(
        'vaplayer.ru',
        '/embed/movie/$tmdbId',
        _vidApiQuery(settings),
      );

  static Uri? _vidApiShow(int tmdbId, ProfilePlaybackSettings settings) =>
      Uri.https(
        'vaplayer.ru',
        '/embed/tv/$tmdbId/1/1',
        _vidApiQuery(settings),
  ...
  static Uri _vidNestMovie(int tmdbId, ProfilePlaybackSettings settings) =>
      Uri.https(
        'vidnest.fun',
        '/movie/$tmdbId',
        const <String, String>{'autoplay': '1'},
      );
  static Uri? _vidNestShow(int tmdbId, ProfilePlaybackSettings settings) =>
      Uri.https(
        'vidnest.fun',
        '/tv/$tmdbId/1/1',
        const <String, String>{'autoplay': '1'},
      );
  static Uri? _vidNestEpisode(
    int tmdbId,
    int season,
    int episode,
    ProfilePlaybackSettings settings,
  ...
  static Uri _vidApiXyzMovie(
    ...
    ProfilePlaybackSettings settings,
      ...
      Uri.https(
        'vidapi.xyz',
        '/embed/movie/$tmdbId',
        const <String, String>{'autoplay': '1', 'muted': '1'},
      );
  static Uri? _vidApiXyzShow(
    int tmdbId,
    ProfilePlaybackSettings settings,
  ) =>
      Uri.https(
  ...
  static Uri _vidSrcXyzMovie(
    ...
    ProfilePlaybackSettings settings,
      ...
      Uri.https(
        'vidsrc.xyz',
        '/embed/movie',
        <String, String>{'tmdb': '$tmdbId', 'autoplay': '1'},
      );
  static Uri? _vidSrcXyzShow(
    int tmdbId,
    ProfilePlaybackSettings settings,
  ) =>
      Uri.https(
  ...
  static Uri _oneElevenMoviesComMovie(
    int tmdbId,
    ProfilePlaybackSettings settings,
  ) =>
      Uri.https(
  ...
  static Uri? _oneElevenMoviesComShow(
    int tmdbId,
    ProfilePlaybackSettings settings,
  ) =>
      Uri.https(
  ...
  static Uri? _oneElevenMoviesComEpisode(
    int tmdbId,
    int season,
    int episode,
    ProfilePlaybackSettings settings,
  ...
  static Uri _vixSrcMovie(int tmdbId, ProfilePlaybackSettings settings) =>
      Uri.https(
        'vixsrc.to',
        '/movie/$tmdbId',
        <String, String>{
          'lang': settings.preferredAudioLanguageCode,
          'autoplay': 'true',
        },
      );
  static Uri? _vixSrcShow(
    int tmdbId,
    ProfilePlaybackSettings settings,
  ) =>
      Uri.https(
  ...
  static Uri? _autoEmbedCcEpisode(
    int tmdbId,
    int season,
    int episode,
    ProfilePlaybackSettings settings,
  ...
  static Uri _vidSrcCcMovie(int tmdbId, ProfilePlaybackSettings settings) =>
      Uri.https(
        'vidsrc.cc',
        '/v3/embed/movie/$tmdbId',
        const <String, String>{'autoPlay': 'true'},
      );
  static Uri? _vidSrcCcShow(
    int tmdbId,
    ProfilePlaybackSettings settings,
  ) =>
      Uri.https(
        'vidsrc.cc',
        '/v3/embed/tv/$tmdbId/1/1',
        const <String, String>{'autoPlay': 'true'},
      );
  static Uri? _vidSrcCcEpisode(
    int tmdbId,
    int season,
    int episode,
    ProfilePlaybackSettings settings,
  ...
  static Uri? _vidsrcEmbedEpisode(int tmdbId, int season, int episode,
          ProfilePlaybackSettings settings) =>
      Uri.https(
        'vidsrc-embed.ru',
        '/embed/tv',
  ...
  static Uri? _vidEasyEpisode(int tmdbId, int season, int episode,
          ProfilePlaybackSettings settings) =>
      Uri.parse('https://vidembed.cc/episode/$tmdbId-$season-$episode');
  static Uri _oneElevenMoviesMovie(
          int tmdbId, ProfilePlaybackSettings settings) =>
      Uri.parse('https://111movies.net/movie/$tmdbId');
  static Uri? _oneElevenMoviesEpisode(int tmdbId, int season, int episode,
          ProfilePlaybackSettings settings) =>
  ...
  static Uri? _vidzeeEpisode(int tmdbId, int season, int episode,
          ProfilePlaybackSettings settings) =>
  ...
  static Uri? _vidsrcEpisode(int tmdbId, int season, int episode,
          ProfilePlaybackSettings settings) =>
      Uri.https(
        'vidsrc.to',
        '/embed/tv/$tmdbId/$season/$episode',
  ...
  static Uri? _twoEmbedEpisode(int tmdbId, int season, int episode,
          ProfilePlaybackSettings settings) =>
  ...
  static Uri? _mappleEpisode(int tmdbId, int season, int episode,
          ProfilePlaybackSettings settings) =>
  ...
  static Uri? _primeSrcEpisode(int tmdbId, int season, int episode,
          ProfilePlaybackSettings settings) =>
      Uri.https(
        'primewire.tf',
        '/embed/tv',
  ...
  static Uri? _multiEmbedEpisode(int tmdbId, int season, int episode,
          ProfilePlaybackSettings settings) =>
      Uri.https(
        'multiembed.mov',
        '/',
  ...
  static Uri? _autoEmbedEpisode(int tmdbId, int season, int episode,
          ProfilePlaybackSettings settings) =>
